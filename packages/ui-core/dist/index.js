...
function me(e2) {
  ...
  }, [e2.stylisPlugins]), import_react.default.createElement(ce.Provider, { value: u2 }, import_react.default.createElement(le.Provider, { value: l2 }, "production" !== process.env.NODE_ENV ? import_react.default.Children.only(e2.children) : e2.children));
}
var ve = function() {
  function e2(e3, t2) {
    var n2 = this;
...
function Ye(e2, t2, n2) {
  ...
  var C2, I2 = new oe(n2, g2, o2 ? e2.componentStyle : void 0), P = I2.isStatic && 0 === c2.length, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      "production" !== process.env.NODE_ENV && (0, import_react.useDebugValue)(h2);
      ...
      }(Oe(t4, (0, import_react.useContext)(Me), a3) || w, t4, o3), y3 = m2[0], g3 = m2[1], S2 = function(e5, t5, n4, r3) {
        var o4 = pe(), s2 = fe(), i4 = t5 ? e5.generateAndInjectStyles(w, o4, s2) : e5.generateAndInjectStyles(n4, o4, s2);
        return "production" !== process.env.NODE_ENV && (0, import_react.useDebugValue)(i4), "production" !== process.env.NODE_ENV && !t5 && r3 && r3(i4), i4;
      ...
      return t4.style && g3.style !== t4.style && (C3.style = v({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h2, S2 !== h2 ? S2 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = b2, (0, import_react.createElement)(_2, C3);
    }(C2, e3, t3, P);
  };
  return O2.displayName = y2, (C2 = import_react.default.forwardRef(O2)).attrs = N2, C2.componentStyle = I2, C2.displayName = y2, C2.shouldForwardProp = A, C2.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : S, C2.styledComponentId = g2, C2.target = o2 ? e2.target : e2, C2.withComponent = function(e3) {
...
var Typography = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledTypography, __spreadProps(__spreadValues({}, props), { children: props.children }));
};
...
var Button = import_react2.default.forwardRef(
  (props, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StyledButton, __spreadProps(__spreadValues({}, props), { ref, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Typography, { lineHeight: "small", fontWeight: "semi", children: props.children }) }));
  }
);
...
var Layer = import_react3.default.forwardRef((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(StyledLayer, __spreadProps(__spreadValues({}, props), { ref, children: props.children }));
});
