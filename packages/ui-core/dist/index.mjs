...
var require_react_is_production_min = __commonJS({
  "../../node_modules/.pnpm/react-is@18.1.0/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    ...
    exports.isValidElementType = function(a2) {
      return "string" === typeof a2 || "function" === typeof a2 || a2 === d2 || a2 === f || a2 === e2 || a2 === m2 || a2 === n2 || a2 === t2 || "object" === typeof a2 && null !== a2 && (a2.$$typeof === q2 || a2.$$typeof === p || a2.$$typeof === g2 || a2.$$typeof === h || a2.$$typeof === l2 || a2.$$typeof === u2 || void 0 !== a2.getModuleId) ? true : false;
    };
    exports.typeOf = v2;
  }
});
...
var require_react_is_production_min2 = __commonJS({
  "../../node_modules/.pnpm/react-is@16.13.1/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    ...
    exports.isValidElementType = function(a2) {
      return "string" === typeof a2 || "function" === typeof a2 || a2 === e2 || a2 === m2 || a2 === g2 || a2 === f || a2 === p || a2 === q2 || "object" === typeof a2 && null !== a2 && (a2.$$typeof === t2 || a2.$$typeof === r2 || a2.$$typeof === h || a2.$$typeof === k2 || a2.$$typeof === n2 || a2.$$typeof === w2 || a2.$$typeof === x2 || a2.$$typeof === y2 || a2.$$typeof === v2);
    };
    exports.typeOf = z2;
  }
});
...
// ../../node_modules/.pnpm/styled-components@5.3.9_zqyshjqmmmqwn6ax6dftxsbcrq/node_modules/styled-components/dist/styled-components.esm.js
var import_react_is = __toESM(require_react_is());
var import_shallowequal = __toESM(require_shallowequal());
import r, { useState as o, useContext as s, useMemo as i, useEffect as a, useRef as c, createElement as u, useDebugValue as l } from "react";

// ../../node_modules/.pnpm/@emotion+stylis@0.8.5/node_modules/@emotion/stylis/dist/stylis.esm.js
...
function D(e2) {
  ...
  throw "production" === process.env.NODE_ENV ? new Error("An error occurred. See https://git.io/JUIaE#" + e2 + " for more information." + (n2.length > 0 ? " Args: " + n2.join(", ") : "")) : new Error(R.apply(void 0, [O[e2]].concat(n2)).trim());
}
var j = function() {
  function e2(e3) {
...
var V = function(e2) {
  ...
  for (; x.has(k); )
    k++;
  var t2 = k++;
  return "production" !== process.env.NODE_ENV && ((0 | t2) < 0 || t2 > 1 << 30) && D(16, "" + t2), T.set(e2, t2), x.set(t2, e2), t2;
};
var z = function(e2) {
  return x.get(e2);
};
...
var q = function(e2) {
  ...
  r2.setAttribute(N, "active"), r2.setAttribute("data-styled-version", "5.3.9");
  var i2 = Y();
...
var X = function() {
  function e2(e3, t3, n2) {
    void 0 === e3 && (e3 = w), void 0 === t3 && (t3 = {}), this.options = v({}, J, {}, e3), this.gs = t3, this.names = new Map(n2), this.server = !!e3.isServer, !this.server && C && U && (U = false, function(e4) {
...
var oe = function() {
  function e2(e3, t2, n2) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = "production" === process.env.NODE_ENV && (void 0 === n2 || n2.isStatic) && ne(e3), this.componentId = t2, this.baseHash = ee(re, t2), this.baseStyle = n2, X.registerId(t2);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.baseStyle && o2.push(this.baseStyle.generateAndInjectStyles(e3, t2, n2)), this.isStatic && !n2.hash)
      ...
      for (var c2 = this.rules.length, u2 = ee(this.baseHash, n2.hash), l2 = "", d2 = 0; d2 < c2; d2++) {
        var h = this.rules[d2];
        if ("string" == typeof h)
          l2 += h, "production" !== process.env.NODE_ENV && (u2 = ee(u2, h + d2));
        else if (h) {
...
var ie = [":", "[", ".", "#"];
function ae(e2) {
  var t2, n2, r2, o2, s2 = void 0 === e2 ? w : e2, i2 = s2.options, a2 = void 0 === i2 ? w : i2, c2 = s2.plugins, u2 = void 0 === c2 ? S : c2, l2 = new stylis_esm_default(a2), d2 = [], p = function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
...
function me(e2) {
  var t2 = o(e2.stylisPlugins), n2 = t2[0], s2 = t2[1], c2 = pe(), u2 = i(function() {
    var t3 = c2;
  ...
  }, [e2.stylisPlugins]), r.createElement(ce.Provider, { value: u2 }, r.createElement(le.Provider, { value: l2 }, "production" !== process.env.NODE_ENV ? r.Children.only(e2.children) : e2.children));
}
var ve = function() {
  function e2(e3, t2) {
    var n2 = this;
...
function Ee(e2) {
  return ye.test(e2) ? e2.replace(ge, we).replace(Se, "-ms-") : e2;
}
var be = function(e2) {
...
function _e(e2, n2, r2, o2) {
  ...
  if (E(e2)) {
    if ("function" != typeof (l2 = e2) || l2.prototype && l2.prototype.isReactComponent || !n2)
      return e2;
    var u2 = e2(n2);
    return "production" !== process.env.NODE_ENV && (0, import_react_is.isElement)(u2) && console.warn(b(e2) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), _e(u2, n2, r2, o2);
  }
  var l2;
  return e2 instanceof ve ? r2 ? (e2.inject(r2, o2), e2.getName(o2)) : e2 : g(e2) ? function e3(t2, n3) {
    var r3, o3, s3 = [];
    for (var i3 in t2)
      t2.hasOwnProperty(i3) && !be(t2[i3]) && (Array.isArray(t2[i3]) && t2[i3].isCss || E(t2[i3]) ? s3.push(Ee(i3) + ":", t2[i3], ";") : g(t2[i3]) ? s3.push.apply(s3, e3(t2[i3], i3)) : s3.push(Ee(i3) + ": " + (r3 = i3, null == (o3 = t2[i3]) || "boolean" == typeof o3 || "" === o3 ? "" : "number" != typeof o3 || 0 === o3 || r3 in unitless_esm_default ? String(o3).trim() : o3 + "px") + ";"));
...
function Ae(e2) {
  for (var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++)
    n2[r2 - 1] = arguments[r2];
  return E(e2) || g(e2) ? Ne(_e(y(S, [e2].concat(n2)))) : 0 === n2.length && 1 === e2.length && "string" == typeof e2[0] ? e2 : Ne(_e(y(e2, n2)));
}
...
var Pe = function(e2, t2) {
  if ("production" !== process.env.NODE_ENV) {
    ...
    try {
      ...
      }, c(), o2 && !Ie.has(n2) && (console.warn(n2), Ie.add(n2));
    } catch (e3) {
...
function Ye(e2, t2, n2) {
  var o2 = _(e2), i2 = !xe(e2), a2 = t2.attrs, c2 = void 0 === a2 ? S : a2, d2 = t2.componentId, h = void 0 === d2 ? function(e3, t3) {
    var n3 = "string" != typeof e3 ? "sc" : je(e3);
    Fe[n3] = (Fe[n3] || 0) + 1;
    var r2 = n3 + "-" + Te("5.3.9" + n3 + Fe[n3]);
    return t3 ? t3 + "-" + r2 : r2;
  }(t2.displayName, t2.parentComponentId) : d2, p = t2.displayName, y2 = void 0 === p ? function(e3) {
    return xe(e3) ? "styled." + e3 : "Styled(" + b(e3) + ")";
  }(e2) : p, g2 = t2.displayName && t2.componentId ? je(t2.displayName) + "-" + t2.componentId : t2.componentId || h, N2 = o2 && e2.attrs ? Array.prototype.concat(e2.attrs, c2).filter(Boolean) : c2, A = t2.shouldForwardProp;
  o2 && e2.shouldForwardProp && (A = t2.shouldForwardProp ? function(n3, r2, o3) {
    return e2.shouldForwardProp(n3, r2, o3) && t2.shouldForwardProp(n3, r2, o3);
  } : e2.shouldForwardProp);
  var C2, I2 = new oe(n2, g2, o2 ? e2.componentStyle : void 0), P = I2.isStatic && 0 === c2.length, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      var o3 = e4.attrs, i3 = e4.componentStyle, a3 = e4.defaultProps, c3 = e4.foldedComponentIds, d3 = e4.shouldForwardProp, h2 = e4.styledComponentId, p2 = e4.target;
      "production" !== process.env.NODE_ENV && l(h2);
      ...
      }(Oe(t4, s(Me), a3) || w, t4, o3), y3 = m2[0], g3 = m2[1], S2 = function(e5, t5, n4, r3) {
        var o4 = pe(), s2 = fe(), i4 = t5 ? e5.generateAndInjectStyles(w, o4, s2) : e5.generateAndInjectStyles(n4, o4, s2);
        return "production" !== process.env.NODE_ENV && l(i4), "production" !== process.env.NODE_ENV && !t5 && r3 && r3(i4), i4;
      }(i3, r2, y3, "production" !== process.env.NODE_ENV ? e4.warnTooManyClasses : void 0), b2 = n3, _2 = g3.$as || t4.$as || g3.as || t4.as || p2, N3 = xe(_2), A2 = g3 !== t4 ? v({}, t4, {}, g3) : t4, C3 = {};
      for (var I3 in A2)
        "$" !== I3[0] && "as" !== I3 && ("forwardedAs" === I3 ? C3.as = A2[I3] : (d3 ? d3(I3, emotion_is_prop_valid_esm_default, _2) : !N3 || emotion_is_prop_valid_esm_default(I3)) && (C3[I3] = A2[I3]));
      return t4.style && g3.style !== t4.style && (C3.style = v({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h2, S2 !== h2 ? S2 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = b2, u(_2, C3);
    }(C2, e3, t3, P);
  };
  return O2.displayName = y2, (C2 = r.forwardRef(O2)).attrs = N2, C2.componentStyle = I2, C2.displayName = y2, C2.shouldForwardProp = A, C2.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : S, C2.styledComponentId = g2, C2.target = o2 ? e2.target : e2, C2.withComponent = function(e3) {
    ...
    return Ye(e3, v({}, o3, { attrs: N2, componentId: s2 }), n2);
  }, Object.defineProperty(C2, "defaultProps", { get: function() {
    return this._foldedDefaultProps;
  }, set: function(t3) {
    this._foldedDefaultProps = o2 ? Be({}, e2.defaultProps, t3) : t3;
  } }), "production" !== process.env.NODE_ENV && (Pe(y2, g2), C2.warnTooManyClasses = function(e3, t3) {
    var n3 = {}, r2 = false;
    return function(o3) {
...
var Je = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!t3)
        return "";
      var n2 = Y();
      return "<style " + [n2 && 'nonce="' + n2 + '"', N + '="true"', 'data-styled-version="5.3.9"'].filter(Boolean).join(" ") + ">" + t3 + "</style>";
      ...
      if (e3.sealed)
        return D(2);
      var n2 = ((t3 = {})[N] = "", t3["data-styled-version"] = "5.3.9", t3.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, t3), o2 = Y();
  ...
  return t2.collectStyles = function(e3) {
    return this.sealed ? D(2) : r.createElement(me, { sheet: this.instance }, e3);
    ...
    if (this.sealed)
      return D(2);
    this.seal();
    var t3 = __require("stream"), n2 = (t3.Readable, t3.Transform), r2 = e3, o2 = this.instance, s2 = this._emitSheetCSS, i2 = new n2({ transform: function(e4, t4, n3) {
...
var getThemeable = (theme, variant) => {
...
var DEFAULT_SIZE = "regular";
var StyledButton = styled_components_esm_default.button`
  ${({ size }) => Ae`
    display: inline-flex;
    align-items: center;

    padding: 0 ${getPaddingHorizontal(size != null ? size : DEFAULT_SIZE)};
    height: ${getHeight(size != null ? size : DEFAULT_SIZE)};
    font-size: ${getFontSize(size != null ? size : DEFAULT_SIZE)};
  ...
  ${({ theme, variant }) => getThemeable(theme, variant != null ? variant : DEFAULT_VARIANT)}
`;

// src/typography/style.tsx
var getLineHeight = (size) => {
  if (size === "small") {
    return "1.5";
  }
  return "1.8";
};
var getFontWeight = (weight) => {
  if (weight === "light") {
    return "300";
  } else if (weight === "semi") {
    return "500";
...
var StyledTypography = styled_components_esm_default.span`
  ${({ lineHeight, fontSize, fontWeight }) => Ae`
...
var Typography = (props) => {
  return /* @__PURE__ */ jsx(StyledTypography, __spreadProps(__spreadValues({}, props), { children: props.children }));
};
...
var Button = React.forwardRef(
  (props, ref) => {
    return /* @__PURE__ */ jsx2(StyledButton, __spreadProps(__spreadValues({}, props), { ref, children: /* @__PURE__ */ jsx2(Typography, { lineHeight: "small", fontWeight: "semi", children: props.children }) }));
  }
);
...
// src/layer/style.tsx
var getThemeable2 = (theme, variant) => {
...
var StyledLayer = styled_components_esm_default.div`
  ${({ theme, variant }) => getThemeable2(theme, variant)}
`;

// src/layer/layer.tsx
import { jsx as jsx3 } from "react/jsx-runtime";
var Layer = React2.forwardRef((props, ref) => {
  return /* @__PURE__ */ jsx3(StyledLayer, __spreadProps(__spreadValues({}, props), { ref, children: props.children }));
});
